...
export function SiteFooter() {
  return (
    <footer className="mt-auto border-t border-zinc-200/70 bg-white dark:border-zinc-700/70 dark:bg-zinc-950">
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-4 px-4 py-8 text-sm text-zinc-600 sm:flex-row sm:items-center sm:justify-between dark:text-zinc-400">
